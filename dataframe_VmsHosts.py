df_VmsHosts = ''
def generate_html_VmsHosts(dataframe: df_VmsHosts):
    html_Vmshosts = f"""
    <html>
    <header>
    ...
    <div class="page-content">  
        <div class="container conteudo-grafico">
          <h1 class="text-center subtitulo-padrao-conteudo">QUANTIDADE DE VMs</h1> 
          {{% include 'VMsHost_somatoriaVMs.html' %}}
        </div>
