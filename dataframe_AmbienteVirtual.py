df_Av = ''
def generate_html_Av(dataframe: df_Av):
    table_html_Av = dataframe.to_html(table_id="table-Av")
    html_Av = f"""
    <html>
    <header>
        ...
        <link rel="stylesheet" type="text/css" href="static/css/ambientevirtual.css"/>
    ...
    <div class="page-content">        
        <div class="container table_ambienteVirtual">
            {table_html_Av}
        </div>
