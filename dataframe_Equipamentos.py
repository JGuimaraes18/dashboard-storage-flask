import pandas as pd
df_Eq = ''
def generate_html_Eq(dataframe: df_Eq):
    #df_Eq=pd.set_option('display.max_rows', 30)
    table_html_Eq = dataframe.to_html(table_id="table-Eq")
    html_Eq = f"""
    <html>
    <header>
        ...
        <link rel="stylesheet" type="text/css" href="static/css/equipamentos.css"/>
  ...
  <div class="page-content">  
    <div class="table_equipamentos">
      <h1 class="text-center subtitulo-padrao-conteudo">Equipamentos</h1> 
      {table_html_Eq}
    </div>
