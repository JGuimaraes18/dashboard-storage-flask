df_VmsCoids = ''
def generate_html_VmsCoids(dataframe: df_VmsCoids):
    html_VmsCoids = f"""
    <html>
    <header>
    ...
    <div class="page-content">  
        <div class="container conteudo-grafico">
          <h1 class="text-center subtitulo-padrao-conteudo">QUANTIDADE DE VMs (AMBIENTE GERAL)</h1> 
          {{% include 'VMs_COIDS_totalGeral.html' %}}
        </div>
