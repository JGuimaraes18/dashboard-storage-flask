df_MemoriaHosts = ''
def generate_html_MemoriaHosts(dataframe: df_MemoriaHosts):
    html_MemoriaHosts = f"""
    <html>
    <header>
    ...
    <div class="page-content">  
        <div class="container conteudo-grafico">
          <h1 class="text-center subtitulo-padrao-conteudo">MEMÓRIA</h1> 
          {{% include 'memoriaHost_somatoriaVMs.html' %}}
        </div>
