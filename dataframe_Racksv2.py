df_Rv2 = ''
def generate_html_Rv2(dataframe: df_Rv2):
    table_html_Rv2 = dataframe.to_html(table_id="table-Rv2")
    html_Rv2 = f"""
    <html>
    <header>
        ...
        <link rel="stylesheet" type="text/css" href="static/css/racksv2.css"/>
    ...
    <div class="page-content">        
        ...
        <div class="table_racksv2">
          <h1 class="text-center subtitulo-padrao-conteudo">Racks</h1> 
          {table_html_Rv2}
        </div>
