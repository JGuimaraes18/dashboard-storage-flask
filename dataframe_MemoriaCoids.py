df_MemoriaCoids = ''
def generate_html_MemoriaCoids(dataframe: df_MemoriaCoids):
    html_MemoriaCoids = f"""
    <html>
    <header>
    ...
    <div class="page-content">  
        <div class="container conteudo-grafico">
          <h1 class="text-center subtitulo-padrao-conteudo">MEMÓRIA (GB - AMBIENTE GERAL)</h1> 
          {{% include 'memoria_COIDS_totalGeral.html' %}}
        </div>
