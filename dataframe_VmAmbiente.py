df_VmAmbiente = ''
def generate_html_VmAmbiente(dataframe: df_VmAmbiente):
    html_VmAmbiente = f"""
    <html>
    <header>
    ...
    <div class="page-content">  
        <div class="container conteudo-grafico">
          <h1 class="text-center subtitulo-padrao-conteudo">QUANTIDADE DE VMs (POR AMBIENTE)</h1> 
          {{% include 'VMs_por_ambiente.html' %}}
        </div>
