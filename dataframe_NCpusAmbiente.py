df_NCpusAmbiente = ''
def generate_html_NCpusAmbiente(dataframe: df_NCpusAmbiente):
    html_NCpusAmbiente = f"""
    <html>
    <header>
    ...
    <div class="page-content">  
        <div class="container conteudo-grafico">
          <h1 class="text-center subtitulo-padrao-conteudo">N° DE CPUs (POR AMBIENTE)</h1> 
          {{% include 'nCPU_por_ambiente.html' %}}
        </div>
