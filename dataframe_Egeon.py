df_E = ''
def generate_html_E(dataframe: df_E):
    table_html_E = dataframe.to_html(table_id="table-E")
    html_E = f"""
    <html>
    <header>
        ...
        <link rel="stylesheet" type="text/css" href="static/css/egeon.css"/> 
    ...
    <div class="page-content">                
        <div class="container table_egeon">
          <h1 class="text-center subtitulo-padrao-conteudo">Egeon</h1> 
          {table_html_E}
        </div>
