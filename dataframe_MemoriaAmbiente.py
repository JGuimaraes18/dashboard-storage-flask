df_MemoriaAmbiente = ''
def generate_html_MemoriaAmbiente(dataframe: df_MemoriaAmbiente):
    html_MemoriaAmbiente = f"""
    <html>
    <header>
    ...
    <div class="page-content">  
        <div class="container conteudo-grafico">
          <h1 class="text-center subtitulo-padrao-conteudo">MEMÓRIA (POR AMBIENTE)</h1> 
          {{% include 'memoria_por_ambiente.html' %}}
        </div>
